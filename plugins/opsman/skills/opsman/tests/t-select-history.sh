...
# approved of 3); skillthree has no ledger entries at all.
mkdir -p "$repo/.opsman"
{
  jq -cn '{schema_version: 1, run_id: "ops-1", recorded_at: "2026-01-01T00:00:00Z",
           ...
           verdict: {verdict: "APPROVE", score: 95}}'
...
# skilltwo: (0 + 2.5) / (3 + 5) = 0.31 -- three past runs, none approved
